...
export function ContactForm() {
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col border border-rurikon-border rounded bg-rurikon-50/30 w-full max-w-lg">
        <div className="border-b border-rurikon-border">
          <div className="px-[clamp(0.75rem,2vw,1rem)] py-[clamp(0.375rem,1vw,0.5rem)] flex items-center gap-[clamp(0.5rem,1.5vw,0.75rem)]">
            ...
            <input
              ...
              className="flex-1 min-w-0 text-[clamp(0.95rem,1.5vw,1rem)] text-rurikon-600 font-serif bg-transparent border-none outline-none placeholder:italic"
            ...
            <nav aria-label="Social links" className="flex items-center gap-[clamp(0.5rem,1.5vw,0.75rem)] text-rurikon-300 text-[clamp(0.85rem,1.5vw,0.96rem)] shrink-0">
              {SOCIALS.map((s, i) => (
                <Fragment key={s.href}>
                  {i > 0 && <span className="hidden md:inline text-rurikon-200">·</span>}
                  <a
                    href={s.href}
                    target="_blank"
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-[0.9em] w-[0.9em]">
                      <path
                        ...
                        clipRule={s.evenOdd ? 'evenodd' : undefined}
                      />
                    </svg>
        ...
        <textarea
          ...
          className={cn(
            ...
            'min-h-[clamp(160px,22vw,300px)] px-[clamp(0.75rem,2vw,1rem)] py-[clamp(0.5rem,1.5vw,0.75rem)]',
            'text-[clamp(0.95rem,1.7vw,1rem)] text-rurikon-600 font-serif leading-normal',
